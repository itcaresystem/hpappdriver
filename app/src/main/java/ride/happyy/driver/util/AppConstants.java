...
import ride.happyy.driver.model.CountryListBean;
...
public class AppConstants {
    ...
    public static String WEB_ERROR_BASEBEAN_DOWNLOAD_FAIL =App.getInstance().getResources().getString(R.string.message_no_network_available);
    ...
    public static String ACTION_CHOOSE_REMINDER = "ride.happyy.driver.action.CHOOSE_REMINDER";
    public static String ACTION_CHOOSE_MONTH = "ride.happyy.driver.action.CHOOSE_MONTH";
    public static String ACTION_CHOOSE_DAY = "ride.happyy.driver.action.CHOOSE_DAY";
    public static String ACTION_CHOOSE_YEAR = "ride.happyy.driver.action.CHOOSE_YEAR";
    public static String ACTION_CHOOSE_COURT_TYPE = "ride.happyy.driver.action.CHOOSE_COURT_TYPE";
    public static String ACTION_CHOOSE_COUNTRY = "ride.happyy.driver.action.CHOOSE_COUNTRY";
    public static String ACTION_CHOOSE_STATE = "ride.happyy.driver.action.CHOOSE_STATE";
    public static String ACTION_CHOOSE_DISTRICT = "ride.happyy.driver.action.CHOOSE_CITY";
    public static String ACTION_CHOOSE_AGE = "ride.happyy.driver.action.CHOOSE_AGE";
